...
type IDict interface {
	// CreateDict 创建字典
	CreateDict(ctx context.Context, c *model.Dict) (*r.Resp, error)
	// UpdateDict 更新字典
	UpdateDict(ctx context.Context, c *model.Dict) (*r.Resp, error)
	...
	GetDictMap(ctx context.Context, c *model.Dict) (*r.Resp, error)
}
...
func (b bDict) CreateDict(ctx context.Context, c *model.Dict) (*r.Resp, error) {
...
func (b bDict) UpdateDict(ctx context.Context, c *model.Dict) (*r.Resp, error) {
	//TODO implement me
	panic("implement me")
}
...
func (b bDict) GetDictMap(ctx context.Context, c *model.Dict) (*r.Resp, error) {
	//TODO implement me
	panic("implement me")
}
