...
func newSysUser(db *gorm.DB, opts ...gen.DOOption) sysUser {
	...
	_sysUser.PhoneNo = field.NewString(tableName, "phone_no")
	_sysUser.Email = field.NewString(tableName, "email")
	_sysUser.Birthday = field.NewTime(tableName, "birthday")
...
type sysUser struct {
	...
	ALL       field.Asterisk
	ID        field.Uint32
	Username  field.String // 账户名
	Password  field.String
	PhoneNo   field.String // 手机号
	Email     field.String
...
func (s *sysUser) updateTableName(table string) *sysUser {
	...
	s.PhoneNo = field.NewString(table, "phone_no")
	s.Email = field.NewString(table, "email")
	s.Birthday = field.NewTime(table, "birthday")
