...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.AdminCount = field.NewInt32(tableName, "admin_count")
...
type role struct {
	...
	Status      field.Bool   // 启用状态：0->禁用；1->启用
	Sort        field.Int32
...
func (r *role) updateTableName(table string) *role {
	...
	r.AdminCount = field.NewInt32(table, "admin_count")
...
func (r *role) fillFieldMap() {
	...
	r.fieldMap["admin_count"] = r.AdminCount
